...
{
	check_conversions<Micrometers, Inches>(3.937007874e-05, 25400);
}
...
{
	check_conversions<Micrometers, Feet>(3.280839895e-6, 304800);
}

TEST_F(TestLengthUnitsConversions, millimeter_to_feet)
{
	check_conversions<Millimeters, Feet>(3.280839895e-3, 304.8);
}

TEST_F(TestLengthUnitsConversions, centimeter_to_feet)
{
	check_conversions<Centimeters, Feet>(3.280839895e-2, 30.48);
}
...
{
	maxError = 1e-9;
	check_conversions<Micrometers, Yards>(1.0936132983e-6, 914400);
}

TEST_F(TestLengthUnitsConversions, millimeter_to_yards)
{
	check_conversions<Millimeters, Yards>(1.0936132983e-3, 914.4);
}

TEST_F(TestLengthUnitsConversions, centimeter_to_yards)
{
	check_conversions<Centimeters, Yards>(1.0936132983e-2, 91.44);
}
