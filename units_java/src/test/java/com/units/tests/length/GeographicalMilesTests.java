...
public class GeographicalMilesTests {
	...
	public void testComparisonToSmallerValue() {
		GeographicalMiles unit = new GeographicalMiles(3.1);
		GeographicalMiles comparedUnit = new GeographicalMiles(3.0);
	...
	public void testComparisonToEqualValue() {
		GeographicalMiles unit = new GeographicalMiles(3.1);
		GeographicalMiles comparedUnit = new GeographicalMiles(3.1);
		assertFalse(unit.lessThan(comparedUnit));
	...
	public void testComparisonToBiggerValue() {
		GeographicalMiles unit = new GeographicalMiles(3.1);
		GeographicalMiles comparedUnit = new GeographicalMiles(3.2);
	...
	public void testEqualsNullFails() {
		...
		assertFalse("two units are equal, even though one of the is null",
					new GeographicalMiles(actualValue).equals(null));
	}
