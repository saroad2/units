...
public class Yards extends NumericValue implements Length{
	...
	public static Yards castFrom(AnonymousUnit other) {
		validateTypeCode(other.typeCode(), IllegalUnitsCasting.class);
		return castFromWithoutValidate(other);
	}
	
	private static Yards castFromWithoutValidate(Unit other) {
		return new Yards(other.value() * other.scale() / _scale);
	}
