...
public class KilometersTests {
	...
	public void testEqualsSuccess() {
		...
		assertTrue("two units are not equal, even though thet have the same value",
				new Kilometers(actualValue).equals(new Kilometers(actualValue)));
	}

	@Test
	public void testEqualsNullFails() {
		double actualValue = 3.1;
		assertFalse("two units are equal, even though one of the is null", new Kilometers(actualValue).equals(null));
	}
	...
	public void testEqualsOtherWithDifferemtValueFail() {
		...
		assertFalse("two units are equal, even though thet have the different values",
				new Kilometers(value1).equals(new Kilometers(value2)));
	}
