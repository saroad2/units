...
public class DegreesOfLatitudeTests {
	...
	public void testEqualsSuccess() {
		...
		assertTrue("two units are not equal, even though thet have the same value",
				new DegreesOfLatitude(actualValue).equals(new DegreesOfLatitude(actualValue)));
	}

	@Test
	public void testEqualsNullFails() {
		double actualValue = 3.1;
		assertFalse("two units are equal, even though one of the is null", new DegreesOfLatitude(actualValue).equals(null));
	}
	...
	public void testEqualsOtherWithDifferemtValueFail() {
		...
		assertFalse("two units are equal, even though thet have the different values",
				new DegreesOfLatitude(value1).equals(new DegreesOfLatitude(value2)));
	}
