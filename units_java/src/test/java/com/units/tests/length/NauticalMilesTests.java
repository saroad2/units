...
public class NauticalMilesTests {
	...
	public void testComparisonToSmallerValue() {
		NauticalMiles unit = new NauticalMiles(3.1);
		NauticalMiles comparedUnit = new NauticalMiles(3.0);
	...
	public void testComparisonToEqualValue() {
		NauticalMiles unit = new NauticalMiles(3.1);
		NauticalMiles comparedUnit = new NauticalMiles(3.1);
		assertFalse(unit.lessThan(comparedUnit));
	...
	public void testComparisonToBiggerValue() {
		NauticalMiles unit = new NauticalMiles(3.1);
		NauticalMiles comparedUnit = new NauticalMiles(3.2);
	...
	public void testEqualsNullFails() {
		...
		assertFalse("two units are equal, even though one of the is null",
					new NauticalMiles(actualValue).equals(null));
	}
