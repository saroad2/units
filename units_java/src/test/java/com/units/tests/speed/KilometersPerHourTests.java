...
public class KilometersPerHourTests {
	...
	public void testComparisonToSmallerValue() {
		KilometersPerHour unit = new KilometersPerHour(3.1);
		KilometersPerHour comparedUnit = new KilometersPerHour(3.0);
	...
	public void testComparisonToEqualValue() {
		KilometersPerHour unit = new KilometersPerHour(3.1);
		KilometersPerHour comparedUnit = new KilometersPerHour(3.1);
		assertFalse(unit.lessThan(comparedUnit));
	...
	public void testComparisonToBiggerValue() {
		KilometersPerHour unit = new KilometersPerHour(3.1);
		KilometersPerHour comparedUnit = new KilometersPerHour(3.2);
	...
	public void testEqualsNullFails() {
		...
		assertFalse("two units are equal, even though one of the is null",
					new KilometersPerHour(actualValue).equals(null));
	}
